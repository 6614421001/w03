    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: const SingleChildScrollView(
          child: Column(
            children: [
              ImageSection(image: 'imag/w03.jpg'),
              TitleSection(
                name: 'Singapore',
                location: ' Merlion',
              ),
              ...
              TextSection(
                description:
                    'The Merlion is a famous symbol of Singapore and a must-see landmark for tourists visiting the country. '
                    'This unique half-lion, half-fish statue can be found at several key attractions across Singapore, '
                    'with the most iconic one located at Marina Bay. Recognized worldwide, the Merlion has become a true '
                    'representation of Singapore that visitors remember long after their trip.',
              ),
            ],
          ),
        ),
